...
module.exports.cateAdd = function (req, res) {
    res.render("category/add-cate", { id: req.cookies.loginid, errs1: req.flash('message') })
};
...
module.exports.cateEdit = function (req, res) {
    Category.findById(req.params.id, function (err, data) {
        if (err) {
            ...
            res.render('category/edit-cate', { Category: data, id: req.cookies.loginid, errs1: req.flash('message') });
        }
    })
}
